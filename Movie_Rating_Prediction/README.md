...
Exploratory Data Analysis (EDA) – Checked column info, missing values, and initial statistics.
Data Cleaning – Removed rows with missing Rating or key features.
Feature Selection – Selected relevant features: Genre, Director, Actor 1, Actor 2, Actor 3.
Encoding – Converted categorical text features into numeric values using Label Encoding.
...
Evaluation – Evaluated model performance using:
